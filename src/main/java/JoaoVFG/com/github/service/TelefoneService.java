...
public class TelefoneService {
	...
	public List<Telefone> findByPessoa(Integer pessoaId){
		Optional<List<Telefone>> telefones = Optional.of(telefoneRepository.findBypessoa(pessoaService.findById(pessoaId)));
	...
	public List<Telefone> findByPessoaTipoNum(Integer pessoaId, String tipoNum){
		Optional<List<Telefone>> telefones = Optional.of(telefoneRepository.findBypessoaAndtipoNumero(pessoaId, tipoNum));
		return telefones.orElseThrow(() -> new ObjectNotFoundException(
